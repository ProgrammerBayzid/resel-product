        ...
        <div className='mt-24'>
            ...
            <footer className="p-4  sm:p-6 bg-indigo-400 rounded">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            ...
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Recondition Phones</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link to="/" className="hover:underline text-white">Recondition Phones</Link>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center ">© 2022 <Link to="/" className="hover:underline text-white">Recondition Phones</Link>. All Rights Reserved.
                    </span>
